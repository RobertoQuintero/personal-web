    ...
    <>
      ...
      <main className="break-points">
        ...
        <p className="paragraph">
          ...
          enfocado principalmente en Frontend. Comencé estudiando con videos de
          Youtube y leyendo algunos libros que los instructores recomendaban.
          Poco a poco fui ganando habilidad descubriendo rutas de aprendizaje
          que proporcionan distintas plataformas de educación online.
        </p>
        <p className="paragraph">
        ...
        <p className="paragraph">
          Pude concluir cursos de tecnologías como HTML5, CSS, Javascript, Node,
          Firebase, Git, React, React Native, entre otros, y continuamente
          intento agregar algun conocimiento extra a mi stack de herramientas.
        </p>
        <p className="paragraph">
        ...
        <p className="paragraph">
          Hice esta página para mostrar algunos de los proyectos que he relizado
